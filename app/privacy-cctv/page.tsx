        ...
        <div className="space-y-8 text-[#374151]">
          ...
          <section>
            <p className="text-sm text-gray-500 mb-6">
              กลุ่มบริษัท ช.เอราวัณ กรุ๊ป ("บริษัท") ได้ติดตั้งกล้องวงจรปิด (CCTV) ภายในและบริเวณรอบ ๆ
          ...
          <CCTVSection title="1. ผู้ควบคุมข้อมูลส่วนบุคคล">
            <p>กลุ่มบริษัท ช.เอราวัณ กรุ๊ป</p>
            <p>75/2 หมู่ 1 ต.ธรรมศาลา อ.เมือง จ.นครปฐม 73000</p>
            <p>โทรศัพท์: 034-305-500 | อีเมล: contactus@ch-erawan.com</p>
          </CCTVSection>
          ...
          <CCTVSection title="9. การติดต่อสอบถาม">
            <div className="bg-gray-50 rounded-xl p-5 text-sm space-y-1">
              ...
              <p>อีเมล: contactus@ch-erawan.com</p>
            </div>
          </CCTVSection>
